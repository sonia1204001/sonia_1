...
slideimages[0].src = "toyota noah.jpg" // set image src property to image path, preloading image in the process
slideimages[1] = new Image()
slideimages[1].src = "toyota_noah_2007_carmudi.jpg"
slideimages[2] = new Image()
slideimages[2].src = "toyota-premio_Myanmar.jpg"
slideimages[3] = new Image()
slideimages[3].src = "1200px-2nd_generation_Toyota_Noah.jpg"
slideimages[4] = new Image()
slideimages[4].src = "img-compare-esquireCompareEx-5.jpg"
slideimages[5] = new Image()
slideimages[5].src = "toyota-premio_Myanmar.jpg"
slideimages[6] = new Image()
slideimages[6].src = "toyota_noah_2007_carmudi.jpg"



</script>

<img src="1200px-2nd_generation_Toyota_Noah.jpg" id="slide" width="112%" height="100%" />
...
slideit()
			...
			<p style="font-size: 25px;"> Our services are very flexible and can be customized according to your need. It provides you with the flexibility to travel wherever you want and whenever you want. Similarly, we also do not have to make frequent stops to pick up other passengers. .... </p>
